...
export const MOCK_VISITS: Visit[] = [
  ...
  },
  {
    ...
    respondents: ['wife'], summary: '地区の活動状況について情報共有。',
    createdAt: now, updatedAt: now,
  },
  {
