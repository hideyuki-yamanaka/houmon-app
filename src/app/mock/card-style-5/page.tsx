...
export default function MockCardStyle5Page() {
  return (
    <div className="min-h-screen bg-[#F5F5F5] pb-20">
      <div className="max-w-[420px] mx-auto px-3 py-4">
        <div className="mb-4">
          <h1 className="text-xl font-bold mb-1">案 5</h1>
          <p className="text-[12px] text-[#6B6B6B]">上端 1px の白いインセットハイライト + 拡散影でガラス感</p>
          <Link href="/mock/card-style" className="text-[12px] underline mt-2 inline-block">← 一覧へ戻る</Link>
        </div>
        <StyleVariantSheet variant={5} />
      </div>
    </div>
  );
}
