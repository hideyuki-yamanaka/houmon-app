...
## person に入れてよいのは「訪問した相手」だけ
記録の対象になる人 (その家を訪ねた相手) の名前だけを person に入れる。
次の人は 絶対に person に入れない:
  - 喋っている本人 (この記録を書いている人)。
    「山中です」「私が行ってきました」のような自己紹介は 対象者ではない。
  - 一緒に行った人 (同行者)。
    「森さんと訪問しました」「◯◯さんと一緒に回った」の ◯◯ は 対象者ではない。
  - 話題に出ただけの第三者 (「◯◯さんが言うには…」など)。
記入者や同行者のことは、名前を消さずに visit.memo に文章として残すこと。

## sei / mei / kana は必ず「同じ 1 人」のもの
漢字が A さん、読み仮名が B さん のように 別人を混ぜてはいけない。
複数の人名が出てきた場合は、まず「どれが訪問した相手か」を決めてから、
その 1 人の漢字と読みだけを person に入れる。
  例) 「山中です。今日は白川大地さんとこに森さんと行ってきました」
      → person は 白川大地 さんだけ (sei="白川" mei="大地")。
        山中 (記入者) と 森 (同行者) は person に入れず memo に残す。
